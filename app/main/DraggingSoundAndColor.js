...
export default class SoundAndColor extends React.Component {
  constructor() {
    super();
    this._panResponder = {}
  ...
  componentWillMount() {
    ...
    makeSounds = async () => {
      ...
      //   uri: yamaha[35]
      // })
      const audios = [audio0, audio1,
        // audio2, audio3, audio4, audio5, audio6, audio7, audio8, audio9, audio10, audio11,
